 ...
 *
 */
public class FilterMappingParser implements XMLParser<Mapping> {
    ...
    public void startElement(Element element) {
        switch (element.getNodeName()) {
            case "filter-mapping": startMapping(); break;
            case "filter-name": startName(element); break;
    ...
    public void endElement(Element element) {
        if (element.getNodeName().equals("filter-mapping")) {
            complete = true;
        }
    }
}
