 ...
 *
 */
public class SwarmAdapterCodec extends MessageToMessageCodec<FullHttpRequest, org.gethydrated.swarm.core.messages.http.HttpResponse> {
    ...
    @Override
    protected void encode(ChannelHandlerContext ctx, org.gethydrated.swarm.core.messages.http.HttpResponse msg, List<Object> out) throws Exception {
